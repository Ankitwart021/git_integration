...
export default class TableStyle {
  ...
  private getColumnDefs(data: Record<string, any>[], op: string | undefined): any[] {
  ...
  public getStyledHtml(data: Record<string, any>[], op?: string): JSX.Element | null {
    ...
    return (
      data.length > 0 ? (<div className="ag-theme-alpine w-100 " style={{ height: 400, width: "100%" }}>
        ...
        <AgGridReact
          rowData={data}
          columnDefs={this.getColumnDefs(data, op)}
          pagination={true}
