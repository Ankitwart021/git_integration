...
export const useWorkflowInbox = (workflowIds:any[], roles: string[]) => {
  return useQuery({
    queryKey: ["workflowInbox", workflowIds, roles],
    queryFn: () => api.fetchWorkflowInbox(workflowIds, roles),
    enabled: !!workflowIds, // prevent running when userId is null/undefined
  });
};
